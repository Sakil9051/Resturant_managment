...
<head>
    ...
    <title>Inventory Management - RestoAdmin</title>
    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <div class="w-64 gradient-bg text-white flex-shrink-0 shadow-2xl">
            ...
            <nav class="mt-6">
                ...
                <a href="<?= base_url('admin/inventory') ?>" class="flex items-center px-6 py-3 bg-white bg-opacity-20 border-l-4 border-white">
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <header class="bg-white shadow-sm z-10">
                <div class="flex items-center justify-between px-8 py-4">
                    <div>
                        ...
                        <p class="text-sm text-gray-500 mt-1">Track ingredients and stock levels</p>
                    </div>
            ...
            <main class="flex-1 overflow-y-auto bg-gray-50 p-8">
                ...
                <div class="flex justify-end mb-6">
                    <button onclick="document.getElementById('addIngredientModal').classList.remove('hidden')" class="bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white px-6 py-2 rounded-lg shadow-md transition-all flex items-center">
                ...
                <div class="bg-white rounded-xl shadow-sm overflow-hidden">
                    <div class="px-6 py-4 border-b border-gray-200 bg-gray-50 flex justify-between items-center">
                        ...
                        <div class="flex space-x-2">
                            <input type="text" placeholder="Search ingredients..." class="border rounded-lg px-3 py-1 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
                        </div>
                    </div>
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr class="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 font-medium"><?= $item['quantity'] ?></td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <?php if($item['quantity'] < 10): ?>
                                            <span class="px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-full bg-red-100 text-red-800">
                                                <i class="fas fa-exclamation-circle mr-1 self-center"></i> Low Stock
                                            </span>
                                        <?php else: ?>
                                            <span class="px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800">
                                                <i class="fas fa-check-circle mr-1 self-center"></i> In Stock
                                            </span>
                                        <?php endif; ?>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <a href="<?= base_url('admin/inventory/edit/' . $item['id']) ?>" class="text-blue-600 hover:text-blue-900 mr-3" title="Edit">
                                            <i class="fas fa-edit"></i>
                                        </a>
<button onclick="openDeleteModal('<?= base_url('admin/inventory/delete/' . $item['id']) ?>')" class="text-red-600 hover:text-red-900" title="Delete">
    ...
    <div id="addIngredientModal" class="fixed inset-0 bg-black bg-opacity-50 hidden flex items-center justify-center z-50 backdrop-blur-sm transition-all">
        <div class="bg-white rounded-xl shadow-2xl p-8 w-96 relative transform transition-all scale-100">
            <button onclick="document.getElementById('addIngredientModal').classList.add('hidden')" class="absolute top-4 right-4 text-gray-400 hover:text-gray-600 transition-colors">
                <i class="fas fa-times text-xl"></i>
            </button>
            <h2 class="text-2xl font-bold mb-6 text-gray-800 border-b pb-2">Add Ingredient</h2>
            <form action="<?= base_url('admin/inventory/add') ?>" method="post">
                <div class="mb-4">
                ...
                <div class="flex space-x-4 mb-4">
                    <div class="w-1/2">
                        ...
                        <input type="number" step="0.01" name="quantity" class="border border-gray-300 rounded-lg w-full py-2.5 px-3 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all" required>
                    </div>
                    <div class="w-1/2">
                        <label class="block text-gray-700 text-sm font-semibold mb-2">Unit</label>
                        <select name="unit" class="border border-gray-300 rounded-lg w-full py-2.5 px-3 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all">
                ...
                <div class="mb-6">
                    <label class="block text-gray-700 text-sm font-semibold mb-2">Min Threshold</label>
                    <input type="number" step="0.01" name="min_threshold" class="border border-gray-300 rounded-lg w-full py-2.5 px-3 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all" placeholder="Alert when below..." required>
                </div>
