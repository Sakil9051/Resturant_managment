...
<head>
    ...
    <title>Edit Table - RestoAdmin</title>
            ...
            <header class="bg-white shadow-sm z-10">
                <div class="flex items-center justify-between px-8 py-4">
                    <div>
                        ...
                        <p class="text-sm text-gray-500 mt-1">Update table details and status</p>
                    </div>
            ...
            <main class="flex-1 overflow-y-auto bg-gray-50 p-8">
                <div class="bg-white rounded-xl shadow-sm p-8 max-w-2xl mx-auto">
                    <form action="<?= base_url('admin/tables/update/' . $table['id']) ?>" method="post">
                        <div class="mb-6">
                            <label class="block text-gray-700 text-sm font-bold mb-2">Table Number</label>
                            <input type="text" name="table_number" value="<?= esc($table['table_number']) ?>" class="border border-gray-300 rounded-lg w-full py-2.5 px-3 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all" required>
                        </div>
                        <div class="mb-6">
                            <label class="block text-gray-700 text-sm font-bold mb-2">Seats</label>
                            <input type="number" name="seats" value="<?= esc($table['seats']) ?>" class="border border-gray-300 rounded-lg w-full py-2.5 px-3 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all" required>
                        </div>
                        <div class="mb-8">
                            <label class="block text-gray-700 text-sm font-bold mb-2">Status</label>
                            <select name="status" class="border border-gray-300 rounded-lg w-full py-2.5 px-3 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all">
                        ...
                        <div class="flex justify-end space-x-4">
                            <a href="<?= base_url('admin/tables') ?>" class="bg-gray-100 hover:bg-gray-200 text-gray-800 font-bold py-2.5 px-6 rounded-lg transition-all">Cancel</a>
                            <button type="submit" class="bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-bold py-2.5 px-6 rounded-lg shadow-md transition-all transform hover:-translate-y-0.5">Update Table</button>
                        </div>
                    </form>
                </div>
            </main>
